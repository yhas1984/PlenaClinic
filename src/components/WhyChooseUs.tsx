const features = [
  {
    ...
    description: "Equipos médicos de última generación para procedimientos seguros y resultados óptimos.",
    icon: (
  ...
  },
  {
    ...
    description: "Equipo médico con amplia formación y experiencia en cirugía plástica y medicina estética.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Cada paciente recibe un plan de tratamiento diseñado según sus necesidades y objetivos.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Espacios modernos y equipados para brindarte la máxima comodidad y seguridad.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Acompañamiento continuo durante tu recuperación para garantizar los mejores resultados.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Nuestro enfoque prioriza realzar tu belleza manteniendo la armonía y naturalidad.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-on-scroll">
          ...
          <p className="text-text-muted text-lg max-w-2xl mx-auto">
            Nos diferenciamos por la calidad de nuestro servicio, la calidez humana y los resultados que hablan por sí solos.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, i) => (
            <div
              key={i}
              className={`bg-white rounded-2xl p-8 border border-gray-100 hover:shadow-lg transition-all animate-on-scroll delay-${(i % 4) + 1}`}
            >

        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              ...
              className="bg-primary hover:bg-primary-dark text-white px-6 py-2.5 rounded-full transition-colors font-medium"
            >
              Agendar Cita
            </a>
          </div>
          ...
          <div className="md:hidden pb-6 border-t border-gray-100">
            <div className="flex flex-col gap-4 pt-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-primary hover:bg-primary-dark text-white px-6 py-3 rounded-full transition-colors font-medium text-center"
                onClick={() => setMenuOpen(false)}
              >
                Agendar Cita
              </a>
